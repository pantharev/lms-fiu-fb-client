    ...
    function () {
      ...
      */
      ...
      _createClass(StudentService, [{
        key: "getStudents",
        value: function getStudents(pageNo, npp) {
          var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set("page", pageNo).set("npp", npp);
          var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().set('Content-Type', 'application/json');
          return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiURL, "/students"), {
            headers: headers,
            params: params
          });
        }
        ...
        value: function getInstructors() {
          return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiURL, "/students/i"));
        }
      }, {
        key: "addStudent",
        value: function addStudent(student) {
          return this.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiURL, "/students"), student);
        }
      }, {
        key: "updateStudent",
        value: function updateStudent(student) {
          return this.http.put("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiURL, "/students/"), student);
        }
      }, {
        ...
        value: function getStudentByEmail(studentEmail) {
          ...
          return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiURL, "/students/").concat(studentEmail));
        }
      }, {
        key: "deleteStudent",
        value: function deleteStudent(id) {
          return this.http["delete"]("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiURL, "/students/").concat(id));
        }
      }]);
